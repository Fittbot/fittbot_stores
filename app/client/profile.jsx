...
const ProfileScreen = () => {
  ...
  const handleAvatarUpload = async (imageUri) => {
    ...
    try {
      ...
      const res = await axiosInstance.post("/profile_pic/confirm", {
        cdn_url,
        client_id: clientId,
      });
      if (res?.status === 200) {
    ...
    return (
      <View style={styles.tabContent}>
        ...
        <View style={styles.detailItem}>
          ...
          <View style={styles.detailContent}>
            <Text style={styles.detailLabel}>Training Details</Text>
            <Text style={styles.detailValue}>{gymData?.traning_plans}</Text>
          </View>
        </View>
        ...
        <View style={styles.detailItem}>
          ...
          <View style={styles.detailContent}>
            <Text style={styles.detailLabel}>Fee Details</Text>
            <Text
              style={styles.detailValue}
            >{`${gymData?.traning_amount}/month`}</Text>
          </View>
        </View>
      </View>
    );
