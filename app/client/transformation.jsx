    ...
    try {
      ...
      if (filteredFiles.length === 0) {
        showToast({
          type: "error",
          title: "No Images",
          desc: "no images found for the selected date range",
        });
        return;
      }
    ...
    <SafeAreaView style={styles.container} edges={["right", "bottom", "left"]}>
      ...
      >
        <View style={styles.contentWrapper}>
          ...
          {submittedDates && (
            <View>
              {submittedDates && slideshowImages.length > 0 && (
                <View style={styles.slideshowContainer}>
                  <TouchableOpacity
                    onPress={startSlideshow}
                    style={styles.arrowButton}
                  >
                    <Text style={styles.slideshowText}>View as Slideshow</Text>
                    <MaterialIcons
                      name="slideshow"
                      size={16}
                      color="#297DB3"
              ...
              <View style={styles.imagesSection}>
                ...
                >
                  <Text style={styles.imageLabel}>{submittedDates.toDate}</Text>
                  {foundImages.secondImage ? (
                    <Image
