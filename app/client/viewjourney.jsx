...
const ViewJourney = () => {
      ...
      <View style={styles.progressContainer}>
        ...
        <View style={styles.markersContainer}>
          <View style={styles.markerItem}>
            <View style={[styles.markerDot, { backgroundColor: "#5B2B9B" }]} />
            <Text style={styles.weightText}>{start} kg</Text>
            <Text style={styles.weightLabel}>Start</Text>
          </View>

          <View style={styles.markerItem}>
            <View style={[styles.markerDot, { backgroundColor: "#FF3C7B" }]} />
  ...
  const historicalJourneys = weightData.journeys.filter(
            ...
            {displayedHistoricalJourneys.map((journey, index) => (
              <View key={journey.id} style={styles.card}>
                <View style={styles.journeyHeader}>
                  <Text style={styles.sectionTitle}>Journey {index + 1}</Text>
                  <View
            ...
            displayedHistory.map((item, index) => (
              <View key={index} style={styles.historyItem}>
                ...
                <View style={styles.downArrow}>
                  <AntDesign
                    name={item.status ? "arrowup" : "arrowdown"}
                    size={14}
