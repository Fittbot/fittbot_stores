...
const PaymentMethodModal = ({ visible, onClose, planData }) => {
  ...
  const handleSelectPaymentProvider = (provider) => {
    ...
    router.push({
      ...
      params: {
        ...
        offerprice: planData?.discountedPrice || 0,
        duration: planData?.duration || "Monthly",
        price: planData?.mrp || 0,
          ...
          <TouchableWithoutFeedback>
            ...
            >
              {showInfoScreen ? (
                ...
                <View style={styles.billingChoiceContainer}>
                  ...
                  >
                    <View style={styles.providerInfo}>
                      <Image
                        source={require("../../../assets/images/notification-icons.png")}
