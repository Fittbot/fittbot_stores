...
const WorkoutSelection = (props) => {
  ...
  const workoutTypes = [
    {
      id: "scan",
      title: "Scan & Quick Workout",
      subtitle: "Know Your Equipment Before You Lift",
      imagePath: require("../../../assets/images/Workout 03.png"),
      buttonText: "Scan QR",
      charWidth: 130,
      charHeight: 110,
    },
    {
      id: "fittbot",
      title: "Fittbot Workout",
      subtitle: "Your Personal Fitness Companion",
      imagePath:
        gender.toLowerCase() === "male"
          ? require("../../../assets/images/FITTBOT_WORKOUT_02 1.png")
          : require("../../../assets/images/PERSONAL_WORKOUT_02_FEMALE 3.png"),
      buttonText: "Start Now",
      charWidth: isTablet() ? 170 : 140,
...

    {
      ...
      subtitle: "Skip setup. Start sweating with our plans",
      imagePath:
        gender.toLowerCase() === "male"
          ? require("../../../assets/images/MALE_trainerV001 3.png")
          : require("../../../assets/images/SET_YOUR DIET_FEMALE 4.png"),
      buttonText: "Start Now",
      charWidth: isTablet() ? 170 : 140,
      charHeight: isTablet() ? 140 : 140,
    },
    {
      ...
      subtitle: "Create your personal workout",
      imagePath:
        gender.toLowerCase() === "male"
          ? require("../../../assets/images/Workout 02.png")
          : require("../../../assets/images/PERSONAL_WORKOUT_01_FEMALE 3.png"),
      buttonText: "Start Now",
      charWidth: isTablet() ? 170 : 140,
      charHeight: isTablet() ? 140 : 140,
    },
  ...
  const refreshPunchInDetails = async () => {
    ...
    try {
      ...
      console.log("Error refreshing punch-in details:", error);
    }
  };
