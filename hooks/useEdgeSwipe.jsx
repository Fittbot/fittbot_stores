  ...
  const temporarilyDisableSwipe = useCallback(
    (duration = swipeConfig.temporaryDisableDuration) => {
      ...
      temporaryDisableTimeout.current = setTimeout(() => {
        ...
        if (__DEV__) {
          console.log("Edge swipe: Re-enabled after temporary disable");
        }
      }, duration);

      if (__DEV__) {
        console.log(`Edge swipe: Temporarily disabled for ${duration}ms`);
      }
    },
    ...
    return PanResponder.create({
      ...
      onStartShouldSetPanResponderCapture: (evt, gestureState) => {
        ...
        if (__DEV__ && shouldCapture) {
          console.log(
            "Aggressively capturing edge touch at pageX:",
      ...
      onPanResponderGrant: (evt, gestureState) => {
        ...
        if (__DEV__) {
          console.log("Edge swipe granted and started");
        }
      },
      ...
      onPanResponderRelease: (evt, gestureState) => {
        ...
        if (__DEV__) {
          console.log("Edge swipe released:", {
            dx,
            vx,
            shouldComplete,
          });
      ...
      onPanResponderTerminate: () => {
        if (__DEV__) {
          console.log("Edge swipe terminated");
        }
        completeSwipe(false);
      },
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      if (isIOS) {
        ...
        if (__DEV__) {
          console.log("Edge swipe: Screen focused, pan responder recreated");
        }
      }
      ...
      return () => {
        ...
        if (__DEV__) {
          console.log("Edge swipe: Screen unfocused");
        }
      };
